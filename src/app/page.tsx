...
export default function Home() {
  ...
  const generateTemplate = () => {
    ...
    const intro = platform === "ig"
      ? `Selamat pagi/siang Bapak/Ibu tim ${displayName},\n\nPerkenalkan, saya ${myName} dari Panitia I/O Festival 2026 (BEM FTI UNTAR). Kami mengundang ${displayName} untuk berkolaborasi di festival teknologi tahunan kami pada 4-5 Juni 2026.`
    ...
    if (field === "FMCG") {
      if (targetSize === "Perusahaan Besar") {
        body = platform === "ig"
          ? `Kami menawarkan mass exposure melalui posisi Main Tenant untuk menjaga top of mind awareness ${displayName} di kalangan Gen Z pada acara kami.\n\nMelalui kolaborasi ini, ${displayName} akan mendapatkan keuntungan strategis berikut:\n\n- Izin roaming sampling ke seluruh area festival.\n- Booth ukuran besar di Zone A yang pasti dilewati pengunjung.`
          : `Produk ${displayName} sudah menjadi bagian dari keseharian. Kami menawarkan mass exposure melalui posisi Main Tenant untuk menjaga top of mind awareness di kalangan Gen Z pada acara kami.\n\nMelalui kolaborasi ini, ${displayName} akan mendapatkan keuntungan strategis berikut:\n\n- Izin roaming sampling ke seluruh area festival.\n- Booth ukuran besar di Zone A yang pasti dilewati pengunjung.\n- Ruang luas untuk brand activation atau games.`;
      } else {
        body = platform === "ig"
          ? `Kami menawarkan ${displayName} kesempatan untuk menjual paket bundling produk kebutuhan mahasiswa dengan harga spesial di acara kami.\n\nKeuntungan strategis:\n\n- Menghabiskan stok produk dengan perputaran cepat.\n- Melihat respon langsung mahasiswa terhadap varian produk Anda.`
          : `Kami ingin menawarkan ${displayName} kesempatan untuk menjual paket bundling produk kebutuhan mahasiswa dengan harga spesial di acara kami.\n\nMelalui kolaborasi ini, ${displayName} akan mendapatkan keuntungan strategis berikut:\n\n- Menghabiskan stok produk dengan perputaran cepat.\n- Melihat respon langsung mahasiswa terhadap varian produk Anda.`;
      }
    } else if (field === "Banking & Fintech") {
      if (targetSize === "Perusahaan Besar") {
        body = platform === "ig"
          ? `Kami melihat kehadiran ${displayName} sangat strategis sebagai mitra perbankan utama. Mahasiswa FTI UNTAR adalah digital native yang merupakan target potensial untuk akuisisi nasabah baru.\n\nKeuntungan strategis:\n\n- Akses langsung pembukaan rekening/aplikasi ke ribuan mahasiswa.\n- Spot booth paling premium (Zone A) secara eksklusif.\n- Izin roaming untuk membagikan brosur/QRIS keliling area.`
          : `Sebagai pemimpin di sektor finansial, kami melihat kehadiran ${displayName} sangat strategis sebagai mitra perbankan utama. Mahasiswa FTI UNTAR adalah digital native yang merupakan target potensial untuk akuisisi nasabah baru.\n\nMelalui kolaborasi ini, ${displayName} akan mendapatkan keuntungan strategis berikut:\n\n- Akses langsung pembukaan rekening/aplikasi ke ribuan mahasiswa.\n- Spot booth paling premium (Zone A) secara eksklusif.\n- Izin roaming untuk membagikan brosur/QRIS keliling area.`;
      } else {
      ...
      if (targetSize === "Perusahaan Besar") {
        body = platform === "ig"
          ? `Kami menawarkan ${displayName} posisi Main Tenant untuk mendominasi share of mind di kalangan Gen Z pada acara kami.\n\nKeuntungan strategis:\n\n- Satu-satunya provider di zona utama dengan traffic tertinggi (Zone A).\n- Demo kecepatan internet langsung kepada heavy users.\n- Potensi penjualan paket data secara massal.`
          : `Konektivitas adalah nadi bagi mahasiswa IT. Kami menawarkan ${displayName} posisi Main Tenant untuk mendominasi share of mind di kalangan Gen Z pada acara kami.\n\nKeuntungan strategis:\n\n- Satu-satunya provider di zona utama dengan traffic tertinggi (Zone A).\n- Demo kecepatan internet langsung kepada heavy users.\n- Potensi penjualan paket data secara massal.`;
      } else {
      ...
      if (targetSize === "Perusahaan Besar") {
        body = platform === "ig"
          ? `Kami menawarkan space eksklusif di Zone A untuk melakukan showcase inovasi terbaru ${displayName} di dunia teknologi.\n\nKeuntungan strategis:\n\n- Lokasi terbaik dekat pintu masuk utama.\n- Menarik minat talenta IT terbaik untuk berkarir di tempat Anda.`
          : `Kehadiran ${displayName} akan sangat prestisius. Kami menawarkan space eksklusif di Zone A untuk melakukan showcase inovasi terbaru Anda di dunia teknologi.\n\nKeuntungan strategis:\n\n- Lokasi terbaik dekat pintu masuk utama.\n- Menarik minat talenta IT terbaik untuk berkarir di tempat Anda.\n- Uji coba produk langsung oleh expert user.`;
      } else {
      ...
      if (targetSize === "Perusahaan Besar") {
        body = platform === "ig"
          ? `Kami mengundang ${displayName} menghadirkan pengalaman kuliner terbaik sebagai Main Tenant di acara kami.\n\nKeuntungan strategis:\n\n- Booth ukuran besar di area strategis Zone A.\n- Menjadi satu-satunya brand makanan utama di zona premium.\n- Branding maksimal di titik kumpul pengunjung.`
          : `Kami mengundang ${displayName} menghadirkan pengalaman kuliner terbaik. Sebagai Main Tenant, brand Anda akan menjadi destinasi utama saat jam makan siang dan sore.\n\nKeuntungan strategis:\n\n- Booth ukuran besar di area strategis Zone A.\n- Menjadi satu-satunya brand makanan utama di zona premium.\n- Branding maksimal di titik kumpul pengunjung.`;
      } else {
      ...
      if (targetSize === "Perusahaan Besar") {
        body = platform === "ig"
          ? `Kami menawarkan posisi sebagai Main Tenant Minuman untuk ${displayName} di lokasi paling strategis.\n\nKeuntungan strategis:\n\n- Menjadi satu-satunya brand minuman besar di Zone A.\n- Izin menjajakan produk secara keliling ke seluruh area.\n- Potensi penjualan ribuan cup atau botol selama acara.`
          : `Di tengah aktivitas festival yang padat, produk ${displayName} adalah pelepas dahaga utama. Kami menawarkan posisi sebagai Main Tenant Minuman di lokasi paling strategis.\n\nKeuntungan strategis:\n\n- Menjadi satu-satunya brand minuman besar di Zone A.\n- Izin menjajakan produk secara keliling ke seluruh area.\n- Potensi penjualan ribuan cup atau botol selama acara.`;
      } else {
      ...
      if (targetSize === "Perusahaan Besar") {
        body = platform === "ig"
          ? `Brand ${displayName} akan menjadi pemanis acara yang dicari pengunjung untuk konten sosial media dan kenikmatan rasa.\n\nKeuntungan strategis:\n\n- Spot premium di Zone A untuk menarik perhatian pengunjung sejak pintu masuk.\n- Visual produk mendukung penciptaan konten organik.\n- Izin roaming sales di area acara.`
          : `Kami ingin memanjakan pengunjung dengan ${displayName}. Brand Anda akan menjadi pemanis acara yang dicari pengunjung untuk konten sosial media dan kenikmatan rasa.\n\nKeuntungan strategis:\n\n- Spot premium di Zone A untuk menarik perhatian pengunjung sejak pintu masuk.\n- Visual produk mendukung penciptaan konten organik.\n- Izin roaming sales di area acara.`;
      } else {
      ...
      if (targetSize === "Perusahaan Besar") {
        body = platform === "ig"
          ? `Kami menawarkan posisi eksklusif sebagai Main Tenant untuk ${displayName} guna menjangkau audiens modern kami secara langsung.\n\nKeuntungan strategis:\n\n- Menjadi satu-satunya brand kecantikan di Zone A.\n- Area strategis untuk skin check atau make over.\n- Produk berpotensi dipromosikan organik oleh mahasiswa di media sosial.`
          : `Mahasiswa FTI kini sangat peduli dengan self care. Kami menawarkan posisi eksklusif sebagai Main Tenant untuk menjangkau audiens modern kami secara langsung.\n\nKeuntungan strategis:\n\n- Menjadi satu-satunya brand kecantikan di Zone A.\n- Area strategis untuk skin check atau make over.\n- Produk berpotensi dipromosikan organik oleh mahasiswa di media sosial.`;
      } else {
      ...
      if (targetSize === "Perusahaan Besar") {
        body = platform === "ig"
          ? `Kami menawarkan kemitraan strategis untuk memperkenalkan program dari ${displayName} di lokasi premium kami.\n\nKeuntungan strategis:\n\n- Lokasi Zone A yang ramai untuk konsultasi program.\n- Membangun citra institusi di hadapan ribuan calon mahasiswa atau peserta didik potensial.`
          : `Mahasiswa kami selalu mencari cara untuk upskilling. Kami menawarkan kemitraan strategis untuk memperkenalkan program pascasarjana atau sertifikasi dari ${displayName} di lokasi premium kami.\n\nKeuntungan strategis:\n\n- Lokasi Zone A yang ramai untuk konsultasi program.\n- Membangun citra institusi di hadapan ribuan calon mahasiswa atau peserta didik potensial.`;
      } else {
      ...
      if (targetSize === "Perusahaan Besar") {
        body = platform === "ig"
          ? `Kami menawarkan posisi Main Tenant kepada ${displayName} untuk memberikan exposure maksimal kepada audiens mahasiswa Gen Z dan tech enthusiast kami.\n\nMelalui kolaborasi ini, ${displayName} dapat berinteraksi langsung dengan audiens yang melek digital dalam suasana festival yang dinamis.`
          : `Kami melihat potensi sinergi yang luar biasa dengan ${displayName}. Kami menawarkan posisi Main Tenant di acara kami yang akan memberikan exposure maksimal kepada audiens mahasiswa Gen Z dan tech enthusiast.\n\nMelalui kolaborasi ini, ${displayName} dapat berinteraksi langsung dengan audiens yang melek digital dalam suasana festival yang dinamis.`;
      } else {
        body = platform === "ig"
          ? `Kami mengundang ${displayName} untuk berpartisipasi membuka booth di acara kami guna menjangkau ribuan mahasiswa secara langsung.\n\nLokasi acara sangat strategis untuk memperkenalkan produk atau layanan ${displayName} dengan peluang interaksi audiens yang tinggi.`
          : `Kami mengundang ${displayName} untuk berpartisipasi membuka booth di acara kami. Acara ini merupakan momen tepat untuk menjangkau ribuan mahasiswa secara langsung.\n\nLokasi acara sangat strategis untuk memperkenalkan produk atau layanan ${displayName} dengan peluang interaksi audiens yang tinggi.`;
      }
    }
